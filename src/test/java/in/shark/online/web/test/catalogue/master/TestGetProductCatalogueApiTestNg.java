...
public class TestGetProductCatalogueApiTestNg extends AbstractTestNGSpringContextTests{
	...
	public void testGetProductCatalogue(String apiKey,String apiUri, String moduleId ) {
		...
		BodyContentSpec body = requestBody.contentType(MediaType.APPLICATION_JSON).syncBody(moduleId).exchange()
	...
	public void testGetProductCatalogueLoad(String apiKey, String apiUri, String moduleId, Long maxResponseTimeThreshold)
		...
		getProductCatalogue(apiKey, apiUri, moduleId);
	...
	public void getProductCatalogue(String apiKey,String apiUri, String moduleId ) {
		String url = getUrl(apiUri+"?moduleId="+moduleId);
		WebTestClient testClient = WebTestClient.bindToServer().baseUrl(url).build();
		RequestBodyUriSpec requestBody = testClient.post();
		addHeaders(requestBody, apiKey);
