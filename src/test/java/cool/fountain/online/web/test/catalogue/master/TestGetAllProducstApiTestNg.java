...
public class TestGetAllProducstApiTestNg extends AbstractTestNGSpringContextTests{
	@Value("${server.url}")
	...
	public void testGetAllProducts(String apiKey,String apiUri, String requestJsonfile ) {
	...
	public void testGetAllProductstLoad(String apiKey, String apiUri, String requestJsonfile, Long maxResponseTimeThreshold)
			throws JsonParseException, JsonMappingException, IOException, JSONException, ParseException {
		logger.info("Running testGetAllProductsLoad");
		logger.info("responseTimeThreshold: " + maxResponseTimeThreshold);
		Long startTime = System.currentTimeMillis();
		getAllProducts(apiKey, apiUri, requestJsonfile);
	...
	public void getAllProducts(String apiKey,String apiUri, String requestJsonfile ) {
		String url = getUrl(apiUri);
		WebTestClient testClient = WebTestClient.bindToServer().baseUrl(url).build();
		String json = TestAutomationUtil.getContent(requestJsonfile);
		RequestBodyUriSpec requestBody = testClient.post();
