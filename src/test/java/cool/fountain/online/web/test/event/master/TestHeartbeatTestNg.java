...
public class TestHeartbeatTestNg extends AbstractTestNGSpringContextTests {
	...
	public void testHeartbeat(String apiKey, String apiUri, String requestJsonfile) {
		...
		logger.info("Completed Heartbeat");
	}

	@Test(invocationCount = 100, threadPoolSize = 10)
	@Parameters({ "apiKey", "apiUri", "requestJsonfile", "maxResponseTimeThreshold" })
	public void testHeartBeatLoad(String apiKey, String apiUri, String requestJsonfile, Long maxResponseTimeThreshold)
		...
		heartbeat(apiKey, apiUri, requestJsonfile);
	...
	public void heartbeat(String apiKey, String apiUri, String requestJsonfile) {
		String url = getUrl(apiUri);
		WebTestClient testClient = WebTestClient.bindToServer().baseUrl(url).build();
		String json = TestAutomationUtil.getContent(requestJsonfile);
		RequestBodyUriSpec requestBody = testClient.post();
